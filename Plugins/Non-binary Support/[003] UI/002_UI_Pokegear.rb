...
class PokegearButton < SpriteWrapper
  ...
  def initialize(command,x,y,viewport=nil)
    ...
    elsif $Trainer.nonbinary? && pbResolveBitmap(sprintf("Graphics/Pictures/Pokegear/icon_button_nonbinary"))
...
class PokemonPokegear_Scene
  ...
  def pbStartScene(commands)
    ...
    elsif $Trainer.nonbinary? && pbResolveBitmap(sprintf("Graphics/Pictures/Pokegear/bg_nonbinary"))
      @sprites["background"].setBitmap("Graphics/Pictures/Pokegear/bg_f")
    else
